    ...
    async onClick() {
        ...
        if (lines.length) {
            await this.popup.add(ConfirmPopup, {
                title: _t('¿Limpiar Pedidos?'),
                body: _t('¿Estás seguro de que quieres eliminar todos los pedidos del carrito?'),
            }).then(({confirmed}) =>  {
                if (confirmed == true) {
            ...
            this.notification.add(_t("No hay artículos para eliminar."), 3000);
        }
    }
}
/**
